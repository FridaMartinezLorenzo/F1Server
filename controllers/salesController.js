...
class SalesController {
    showAllsales(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            const respuesta = yield database_1.default.query('SELECT sales.IdSale, users.IdUser, users.Name, users.LastName, Date,products.IdProduct,products.Name as Product, products.Nombre as Producto, Quantity, State FROM sales,sales_products, products, users where sales.IdSale = sales_products.IdSale and sales.IdUser = users.IdUser and products.IdProduct = sales_products.IdProduct;');
            res.json(respuesta);
        });
    }
    getSale(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            const { id } = req.params;
            const respuesta = yield database_1.default.query('SELECT sales.IdSale, users.IdUser, users.Name, users.LastName, Date,products.IdProduct, products.Name as Product, products.Nombre as Producto, Quantity, State FROM sales,sales_products, products, users where sales.IdSale = ? and sales.IdSale = sales_products.IdSale and sales.IdUser = users.IdUser and products.IdProduct = sales_products.IdProduct;', [id]);
    ...
    getSaleByUser(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            const { id } = req.params;
            const respuesta = yield database_1.default.query('SELECT sales.IdSale, users.IdUser, users.Name, users.LastName, Date,products.IdProduct, products.Name as Product, products.Nombre as Producto, Quantity, State FROM sales,sales_products, products, users where sales.IdSale = sales_products.IdSale and sales.IdUser = users.IdUser and products.IdProduct = sales_products.IdProduct and users.IdUser = ?;', [id]);
            if (respuesta.length > 0) {
                res.json(respuesta);
                return;
            }
    ...
    getSaleByProduct(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            const { id } = req.params;
            const respuesta = yield database_1.default.query('SELECT sales.IdSale,users.IdUser, users.Name, users.LastName, Date,products.IdProduct,products.Name as Product, products.Nombre as Producto, Quantity, State FROM sales,sales_products, products, users WHERE products.IdProduct = ? and sales_products.IdSale = sales.IdSale', [id]);
            if (respuesta.length > 0) {
                res.json(respuesta);
                return;
            }
